...
function(properties, context) {
  try {
    if (BubbleToast === undefined) {
      throw {
        error: 'BubbleToast Error',
        message: 'Reference to BubbleToast is undefined',
      };
    }
    ...
    const props = {
      title: !isStringEmpty(properties.title) ? properties.title : '',
      message: !isStringEmpty(bbCodeHTMl(properties.message))
        ? bbCodeHTMl(properties.message)
        : '',
